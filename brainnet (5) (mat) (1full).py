...
data_dir = r'../data/Allztfdata.pkl'
#data_dir = 'Huaxim.mat'
emptyTrain = 1
'''
...
with open(data_dir,'rb') as f:
    data_dic = pk.load(f, encoding='iso-8859-1')
...
#Output layer
W_fc1 = weight_variable([net_size*net_size, fc_size],lam=0.3)
...
'''
hidden1 = tf.nn.softmax(tf.matmul(x, W_fc1) + b_fc1)
hidden1_out = tf.nn.dropout(hidden1,keep_prob)

y_conv = tf.nn.softmax(tf.matmul(hidden1_out, W_fc2) + b_fc2)
#Train and evaluate
